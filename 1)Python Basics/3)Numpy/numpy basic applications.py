# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 22:41:16 2020
...
# 4. 10 elemanlı sıfırlardan oluşan bir numpy dizisini oluşturunuz.
result = np.zeros(10)
# 5. 5 - 10 elemanlı birlerden oluşan bir numpy dizisini oluşturunuz.
result = np.ones(10)
...
# 9. (3 x 5) boyutlarında (10 - 50 ) arasında rastgele bir matris oluşturunuz.
...
result = matris ** 2
# 19. Üretilen matris elemankarının hangisi pozitif çift sayıdır ?
